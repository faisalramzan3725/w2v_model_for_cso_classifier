...
def main_split()->None:
    ...
    # Input file path
    input_file_path = os.path.join("paper_dataset", "paper_dataset.txt") # dataset load
    ...
    affordance = 10000000  # Maximum lines per partition; adjust based on dataset and memory
